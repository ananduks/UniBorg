...
UNIBORG_USER_BOT_WARN_ZERO = "why pm for movies ask in group or sent the moviename to this  @Ananduspmbot."
UNIBORG_USER_BOT_NO_WARN = "go and sent ur messages to this @Ananduspmbot bot and dont disturb 😠😠😠😠"
